                        ...
                        <div class="card card-primary">
                           ...
                           <form>
                              <div class="card-body">
                                 ...
                                 <div class="form-group">
                                    <label for="inputCiudad">Estrato:</label>
                                    <input
                                       type="number"
                                       class="form-control"
                                       id="usuarioEstrato"
                                 ...
                                 <div class="form-group">
                                    <label for="inputlecturaant">
                                       Lectura Anterior:
                                    </label>
                                    <input
                                       type="number"
                                       class="form-control"
                                       id="usuarioLecturaAnt"
                                       name="usuarioLecturaAnt"
                                       value="1200"
                                       disabled
                                    />
                                 </div>
                                 ...
                                 <div class="form-group">
                                    <label for="inputlecturact">
                                       Lectura Actual:
                                    </label>
                                    <input
                                       type="number"
                                       class="form-control"
                                       id="usuarioLecturaAct"
                                       name="usuarioLecturaAct"
                                       placeholder="Digite Nueva Lectura"
                                    />
                                 </div>
